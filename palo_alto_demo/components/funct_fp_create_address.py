...
FN_NAME = "fp_create_address"


class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'fp_create_address'"""
    ...
    def _app_function(self):
        ...
        Function: None
        Inputs:
            -   fn_inputs.palo_alto_create_address
            -   fn_inputs.palo_alto_name
        """
        ...
        # Example accessing optional attribute in fn_inputs and initializing
        # it to None if it does not exist (this is similar for app_configs)
        ...
        #
        # yield self.status_message(f"Endpoint reached successfully and returning results for App Function:
        # '{FN_NAME}'")
        #
        ...
        # Note this is only used for demo purposes! Put your own key/value pairs here that you want
